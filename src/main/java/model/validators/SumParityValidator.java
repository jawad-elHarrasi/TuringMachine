...
/**
 * The {@code SumParityValidator} class is responsible for validating whether the sum of the first and
 * second numbers in a given code is of the same parity (even or odd) as the sum in the secret code.
 * It checks if the sums have matching parities.
 *
 ...
 * @see ValidatorModel
 */
public class SumParityValidator extends ValidatorModel {
    ...
    /**
     * Constructs a {@code SumParityValidator} with the specified secret code.
     *
     * @param secretCode The secret code to validate against.
     */
    public SumParityValidator(Code secretCode) {
        super(secretCode);
        this.isMatching = false;
    }

    /**
     * Checks whether the sum of the first and second numbers in the input code has the same parity as the secret code.
     *
    ...
    public void matching(Code inputCode) throws TuringException {
        ...
        isMatching = sumInput % 2 == 0 && sumSecret % 2 == 0
                || sumInput % 2 != 0 && sumSecret % 2 != 0;
        this.asked = true;
    ...
    /**
     * Gets the current state of whether the sum parity has been asked.
     *
     * @return {@code true} if the sum parity has been asked, {@code false} otherwise.
     */
    ...
    /**
     * Resets the state to indicate that the sum parity has not been asked.
     */
    @Override
    ...
    public String toString() {
        return "Verify if the sum of all numbers is even or odd.";
    }
}
